...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Caleb\Documents\FashionMetadata\InteractiveWebApp'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Caleb\Documents\FashionMetadata\InteractiveWebApp\Scripts\deactivate.nu'
